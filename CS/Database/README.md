...
일반적인 DBMS의 인덱스는 대부분 B-tree 구조로 되어 있다. B-tree에 대한 내용은 [[자료구조]](https://github.com/jojaeng2/Preparing-for-the-interview/tree/main/CS/DataStructure) 파트에 정리를 해놨으니 실제 인덱스는 어떻게 구성되어 있는지 알아보자.  
